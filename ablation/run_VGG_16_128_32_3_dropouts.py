...
hist_json_file = 'history_CXR_Covid-19_{}e_{}_{}_{}_dropouts.json'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS)
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)

# download the model in computer for later use
model.save('CXR_Covid-19_{}e_{}_{}_{}_dropouts.h5'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS))



from tensorflow import keras
model = keras.models.load_model('CXR_Covid-19_{}e_{}_{}_{}_dropouts.h5'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS), custom_objects={'specificity': specificity, 'sensitivity': sensitivity})
...
with open('y_test_list_{}e_{}_{}_{}_dropouts.pkl'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS), 'wb') as f:
    pickle.dump(y_test_list, f)
with open('y_pred_list_{}e_{}_{}_{}_dropouts.pkl'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS), 'wb') as f:
    pickle.dump(y_pred_list, f)

with open('y_test_list_{}e_{}_{}_{}_dropouts.pkl'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS), 'rb') as f:
    y_test_list = pickle.load(f)
with open('y_pred_list_{}e_{}_{}_{}_dropouts.pkl'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS), 'rb') as f:
...
def cm_analysis(y_true, y_pred, labels, ymap=None, figsize=(10,10)):
    ...
    plt.savefig('confusion_matrix_CXR_Covid-19_{}e_{}_{}_{}_dropouts.png'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS))
    plt.savefig('confusion_matrix_CXR_Covid-19_{}e_{}_{}_{}_dropouts.eps'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS))
    #plt.show()

cm_analysis(y_test_list, y_pred_list, [i for i in rev_index] , ymap=None, figsize=(10,10))

with open('report_CXR_Covid-19_{}e_{}_{}_{}_dropouts.txt'.format(EPOCHS, MODEL_NAME,IMG_SIZE,OUTPUT_LAYERS), 'w') as f:
